...
namespace DonorApp.Tests
{
    ...
    public class DonationApiClientTests
    {
        ...
        [Test]
        public async Task ConfirmDonation_BadRequest_ReturnsBadRequestResponse()
        {
            // Arrange
        ...
        [Test]
        public async Task ConfirmDonation_SimulatedServerError_ReturnsInternalServerErrorResponse()
        {
            // Arrange
            var donationDto = CreateSampleDonationDto();
